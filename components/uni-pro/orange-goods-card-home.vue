	...
	<!-- <view> -->
		<view @click="open(itemid)" class="itemInfo1" v-bind:key="itemid">
			...
			<view>
				...
				<view>
					<view v-if="isEnable != '否'" style="display: flex;color: white;margin-left: 16upx;font-size: 20upx;margin-top: 8upx;">
						<view style="border-radius: 10upx;background: #f15b6c;padding: 4upx 8upx 4upx 8upx;">预估返￥{{ tkmoney }}</view>
						<view style="border-radius: 10upx;background: #FF927C;margin-left: 12upx;padding: 4upx 8upx 4upx 8upx;" v-if="tkmoneys != tkmoney">
							升级返￥{{ tkmoneys }}
						</view>
					</view>
