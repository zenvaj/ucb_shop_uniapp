<template>
	<view class="index-content">
		...
		<view style="background: #FFFFFF;">
			<view class="navbar" style="position: fixed;z-index: 100;text-align: center;width: 100%;margin-top:72upx">
		...
		<!--  #ifndef APP-PLUS -->
		<view style="background: #FFFFFF;">
			<view class="navbar" style="position: fixed;z-index: 100;text-align: center;width: 100%;margin-top:6upx">
				<!-- <view v-for="(item, index) in tabList" :key="index" class="nav-item" :class="{ current: fromTabIndex === index }" @tap="fromTabSelect(index)">{{ item.name }}</view> -->
			</view>
			<scroll-view
				scroll-x
...
export default {
	...
	methods: {
		...
		loadPddCouponList: function(type) {
			this.loadingType = 1;
			this.$Request.getT('/pdd/list/keyword/' + this.pddSort + '/page/' + this.page + '/pageSize/10?keyword=' + this.keywords).then(res => {
				this.success = true;
				this.loadingType = 0;
