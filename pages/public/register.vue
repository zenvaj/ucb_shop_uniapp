	...
	<view class="container">
		<view class="wrapper">
			<view class="input-content">
				...
				<view v-if="!invitations" class="cu-form-group" style="border: 2upx solid whitesmoke;margin-bottom: 20px;border-radius: 30px">
					<text class="title">邀请码</text>
					<input type="number" :value="invitation" placeholder="请填写邀请码" data-key="invitation" maxlength="20" @input="inputChange" @confirm="toLogin" />
					<text v-if="!invitations" class="send-msgs" @click="showMa()">官方邀请码</text>
				</view>
			</view>
...
export default {
	...
	methods: {
		...
		toLogin() {
			const { mobile, password, code, showAgree, invitation } = this;
			if (!mobile) {
