<template>
	<view class="index-content" style="margin-top: 74upx;">
		...
		<empty v-if="couponlist.length === 0" des="暂无比价商品" show="false"></empty>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			loadTaoBaoCouponList: function(type) {
				this.loadingType = 1;
				this.$Request.get('/api/supersearch/apikey/maxd/keyword/' + this.keywords + '/back/10/sort/' + this.sort +
