<template>
	<view class="container">
		<!-- #ifdef APP-PLUS -->
		<!-- <view class="list-cell b-b" hover-class="cell-hover" :hover-stay-time="50" @click="loginTb">
			<text class="cell-tit">淘宝授权</text>
			<text style="color: #666666;">{{ tbShow ? '已授权' : '未授权' }}</text>
			<text class="cell-more yticon icon-you"></text>
		</view> -->

		<!-- #endif -->
		<!-- <view style="margin-top: 1px" class="list-cell b-b" hover-class="cell-hover" :hover-stay-time="50" @click="loginWx">
			<text class="cell-tit">关注公众号</text>
			<text style="color: #666666;">{{ wxShow ? '已关注' : '未关注' }}</text>
			<text class="cell-more yticon icon-you"></text>
		</view> -->
		<view style="margin-top: 1px" class="list-cell b-b" @click="appdown" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">APP下载</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
	...
	methods: {
		...
		about(url) {
			uni.showModal({
				...
				title: '关于我们',
				content:
					'优财宝是一个汇聚了全网隐藏优惠券的网购返利软件 ！这里汇聚淘宝、京东、天猫、拼多多等商城优惠券信息！每天实时更新优惠券，发放一些商家的大额优惠券！这里可以帮你网购省钱返利，也可以帮你兼职赚钱！每年最高能让你网购省50%的钱！\n\n青岛缘源信息科技有限公司',
				success: e => {
					if (e.confirm) {
					}
				}
