<template>
	<view class="s-page-wrapper" v-if="showPage">
		<view class="index-goods" v-if="loadGoods">
			...
			<view style="background: rgba(0, 0, 0, 0.7);padding: 16upx;display: flex;font-size: 28upx;font-weight: bold" v-if="goods && grade === '0.7' && isEnable != '否'">
			...
			<view class="goods_info" style="padding-top: 6px;padding-bottom: 16upx">
				<view class="coupon-price s-row">
					<view class="price" style="width: 70%">
						<text style="font-size: 32upx;">券后</text>
				...
				<view v-if="goods.shopname" style="float: right;height: 40upx;line-height: 40upx;margin-top: -16upx;padding-right: 16upx;text-align: right;display: flex;">
			...
			<view class="goods_quan s-row" style="padding-top: 8px;padding-bottom: 8px">
				<view class="row getGoodsLink">
					<view class="is-col-16 money">
						...
						<view class="date-coupon" v-if="goods.start_time">使用期限: {{ goods.start_time }} - {{ goods.end_time }}</view>
					</view>
			...
			<view class="goods_reco" style="display: flex;margin-top: 20upx;">
				<view class="goods-info-title" style="color: #E10A07;width: 20%;text-align: center">必买理由</view>
				<view class="goods_desc" style="padding-bottom: 16upx;padding-top:8px;width: 70%">
					<text>{{ goods.itemdesc }}</text>
					<view @click="shareFriend" style="color: #E10A07;font-size: 28upx;">
