<template>
    <view style="text-align: center;height: 100%;position: absolute;width:100%;background: #F8F8F8;">
        <image style="width: 60px;height: 60px;margin-top: 70px;border-radius:10px" src="../../static/logo2.png">
        </image>
        ...
        <view v-if="!isWeiXin" style="font-size: 16px;margin-top: 10px">微信扫描或搜索关注【优财宝】访问</view>
		<view v-if="isWeiXin" style="font-size: 16px;margin-top: 10px">微信关注【优财宝】访问</view>
