		...
		<view class="top-bckground">
			...
			<view v-if="TabCur==0">
				...
				<view class="swiper" style="padding-top: 220upx;background: white" >
						 ...
						 indicator-active-color="#e10a07" indicator-color="#cccccc" style="height: 240upx;padding: 18upx 16upx 8upx 16upx">
							<block v-for="(item, index3) in banners" :key="index3">
								<swiper-item class="swiper-wrapper" @tap="toGoodsInfo(item.url)">
									<image lazy-load='true' fade-show='true' :src="item.image_url" style="width: 100%;height: 220upx;border-radius: 32upx;" mode="scaleToFill"></image>
								</swiper-item>
							</block>
						</swiper>
					</view>
					...
					<!--首页公告结束-->
					<view style="display: flex;padding: 8upx 20upx 16upx 20upx" v-if="navlist3.length>0">
						<view style="width:48%;height:240upx;background:rgba(248,248,250,1);border-radius:12upx;" @tap="toNavList(navlist3[0].url)">
						...
						<view style="margin-left: 32upx;width:48%;height:120px;background:rgba(248,248,250,1);border-radius:12upx;" @tap="toNavList(navlist3[1].url)">
							<view style="margin:14upx;color: #F15B6C;font-size: 32upx;font-weight: bold;">
								{{navlist3[1].title.split('-')[0]}}
								<text style="font-size: 28upx;margin-left: 12upx;background:rgba(241,91,108,1);border-radius:8upx;color: white;padding: 4upx">{{navlist3[1].title.split('-')[1]}}</text>
							</view>
							<view style="color:rgba(127,134,153,1);font-weight: 400;margin-left: 16upx">{{navlist3[1].title.split('-')[2]}}</view>
							<view style="height: 100px;text-align: center;width: 100%;">
								<image lazy-load='true' fade-show='true' :src="navlist3[1].image_url" style="height: 120upx;width: 180upx;margin-left: 32upx"></image>
							</view>
						</view>
					</view>
					<view style="display: flex;padding: 8upx 20upx 16upx 20upx" v-if="navlist3.length>0">
						<view style="width:48%;height:120upx;background:rgba(248,248,250,1);border-radius:12upx;display: flex" @tap="toNavList(navlist3[2].url)">
							<view>
								<view style="margin:14upx;color: #F15B6C;font-size: 32upx;font-weight: bold;">{{navlist3[2].title.split('-')[0]}}</view>
								<view style="color:rgba(127,134,153,1);font-weight: 400;margin-left: 16upx">{{navlist3[2].title.split('-')[1]}}</view>
							</view>
							<image lazy-load='true' fade-show='true' :src="navlist3[2].image_url" style="border-radius: 16upx;height: 80upx;width: 80upx;margin-top: 20upx;margin-left: 20upx"></image>
						</view>
						<view style="width:48%;height:60px;background:rgba(248,248,250,1);border-radius:12upx;margin-left: 32upx;display: flex"
						 @tap="toNavList(navlist3[3].url)">
							<view>
								<view style="margin:7px;color: #F15B6C;font-size: 16px;font-weight: bold">{{navlist3[3].title.split('-')[0]}}</view>
								<view style="color:rgba(127,134,153,1);font-weight: 400;margin-left: 16upx">{{navlist3[3].title.split('-')[1]}}</view>
							</view>
							<image lazy-load='true' fade-show='true' :src="navlist3[3].image_url" style="border-radius: 16upx;height: 80upx;width: 80upx;margin-top: 20upx;margin-left: 44upx"></image>
						</view>
					</view>
					<view style="display: flex;padding: 8upx 20upx 16upx 20upx" v-if="navlist3.length>0">
						<view style="width:48%;height:120upx;background:rgba(248,248,250,1);border-radius:12upx;display: flex" @tap="toNavList(navlist3[4].url)">
							<view>
								<view style="margin:14upx;color: #F15B6C;font-size: 32upx;font-weight: bold;">{{navlist3[4].title.split('-')[0]}}</view>
								<view style="color:rgba(127,134,153,1);font-weight: 400;margin-left: 16upx">{{navlist3[4].title.split('-')[1]}}</view>
							</view>
							<image :src="navlist3[4].image_url" style="border-radius: 16upx;height: 76upx;width: 76upx;margin-top: 20upx;margin-left: 52upx"></image>
						</view>
						<view style="width:48%;height:120upx;background:rgba(248,248,250,1);border-radius:12upx;margin-left: 32upx;display: flex"
						 @tap="toNavList(navlist3[5].url)">
							<view>
								<view style="margin:14upx;color: #F15B6C;font-size: 32upx;font-weight: bold">{{navlist3[5].title.split('-')[0]}}</view>
								<view style="color:rgba(127,134,153,1);font-weight: 400;margin-left: 16upx">{{navlist3[5].title.split('-')[1]}}</view>
							</view>
							<image :src="navlist3[5].image_url" style="border-radius: 16upx;height: 38px;width: 38px;margin-top: 20upx;margin-left: 8px"></image>
						</view>
					</view>
					...
					<view style="margin: 32upx 32upx 16upx 32upx;" v-if="juhuasuanlist.length>0">
						<view @tap="toNavList('/pages/cate/index', '网红抖货')" style="display: flex;">
							<view style="color: transparent;font-size: 32upx;font-weight: bold;background-image: url(../../static/img/home/wanghongdouhuo.png);background-repeat: round;height: 32upx">
								网红抖货
							</view>
					...
					<view style="display: flex;margin: 16upx;text-align: center;" v-if="juhuasuanlist.length>0">
						<view>
							<view v-for="(g, index7) in juhuasuanlist" :key="index7" class="box-float">
								...
								<view style="font-size: 24upx;position: absolute; bottom: 0; left: 0;background: #F15B6C;color: white;padding-right: 8upx;padding-left: 8upx;border-radius: 8upx;"><text style="font-size: 20upx;">券后￥</text>{{ g.itemendprice }}</view>
							</view>
						</view>
					</view>
					...
					<!-- 领券 -->
					<view class="index-coupon has-pd-10" style="background: ghostwhite;padding-top: 2upx;" v-if="category[0].orderList.length > 0">
						<view style="text-align: center;margin-top: 16upx;margin-bottom: 16upx;">
				...
				<view class="index-coupon has-pd-10" style="margin:200upx 8upx 180upx 8upx ;background: #FFFFFF" v-if="TabCur!=0">
					...
					<view id="shareit" v-if="show_share">
						<image @click="goHongbao" class="arrow" src="../../static/miandan.png"></image>
